...
class Usuario extends DBAbstractModel
{
    ...
    {
        $this->query = "SELECT * FROM usuario WHERE bloqueado=:bloqueado";
    ...
    {
        $this->query = "UPDATE usuario SET bloqueado=:bloqueado WHERE id=:id";
        $this->parametros['bloqueado'] = $this->bloqueado;
        $this->parametros['id'] = $this->id;
        $this->get_results_from_query();
    }
    ...
    {
        $this->query = "SELECT * FROM usuario WHERE user=:user AND psw=:psw";
    ...
    {
        $this->query = "INSERT INTO usuario(nombre, user, psw, email, perfil, bloqueado)
